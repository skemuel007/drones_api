        ...
        public void Configure(EntityTypeBuilder<Drone> builder)
        {
            ...
            builder.HasData(
                new Drone
                {
                    ...
                    SerialNumber = "2ZR5Y-S29XX-OEXDL-VIULN-5XVR4".ToLower(),
                    BatterCapacity = 100,
                    WeightLimit = 200,
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "2IXEI-FNP0E-GMTPA-LXBPL-DZ665".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 200,
                     DroneModelId = new Guid("68679bc6-04a1-4b83-a477-e13c77da04d7"),
                     DroneStateId = new Guid("90e682ba-1235-4085-8030-95a672d66660"),
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "8YTYJ-SS357-1JTOD-12G03-DKZ8Z".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 300,
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "Q8ON7-U6WZH-Z73FD-T8PKH-P1BQH".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 300,
                     DroneModelId = new Guid("b23f8368-a938-43f2-b803-0306e99927f5"),
                     DroneStateId = new Guid("90e682ba-1235-4085-8030-95a672d66660"),
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "O41LM-9NRWP-BHHGK-049U3-3EHJD".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 400,
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "U5ZOC-ESCFO-MAJ11-KQYIW-HYASA".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 400,
                     DroneModelId = new Guid("a353826a-b57f-4675-990f-b76038652cd4"),
                     DroneStateId = new Guid("90e682ba-1235-4085-8030-95a672d66660"),
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "IERFV-JRVS0-CMSTZ-GCWYK-P280M".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 500,
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "JJIMB-GLWFE-QIKFW-G10NF-UNHQX".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 500,
                     DroneModelId = new Guid("79fe7bc1-fafb-4e29-8712-d94b79859648"),
                     DroneStateId = new Guid("90e682ba-1235-4085-8030-95a672d66660"),
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "LLCCV-1AT7T-9MUMK-GSQ6V-264CO".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 500,
                     DroneModelId = new Guid("b23f8368-a938-43f2-b803-0306e99927f5"),
                     DroneStateId = new Guid("90e682ba-1235-4085-8030-95a672d66660"),
                 ...
                 new Drone
                 {
                     ...
                     SerialNumber = "O34BR-EY9W0-DJCYU-VTXNI-N8QGR".ToLower(),
                     BatterCapacity = 100,
                     WeightLimit = 500,
                     DroneModelId = new Guid("79fe7bc1-fafb-4e29-8712-d94b79859648"),
                     DroneStateId = new Guid("90e682ba-1235-4085-8030-95a672d66660"),
